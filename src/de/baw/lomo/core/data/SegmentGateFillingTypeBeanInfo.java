...
public class SegmentGateFillingTypeBeanInfo extends SimpleBeanInfo {
  ...
  public PropertyDescriptor[] getPropertyDescriptors() {
    ...
    try {
      ...
      properties[3] = new PropertyDescriptor("culvertCrossSection", SegmentGateFillingType.class); //$NON-NLS-1$
      ...
      properties[4] = new PropertyDescriptor("culvertLoss", SegmentGateFillingType.class); //$NON-NLS-1$
