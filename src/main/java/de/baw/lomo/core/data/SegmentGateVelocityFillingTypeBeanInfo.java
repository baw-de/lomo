...
public class SegmentGateVelocityFillingTypeBeanInfo extends SimpleBeanInfo {
  ...
  public PropertyDescriptor[] getPropertyDescriptors() {
    ...
    try {
      ...
      properties[3] = new PropertyDescriptor("jetOutletLookup", SegmentGateVelocityFillingType.class); //$NON-NLS-1$
      ...
      properties[4] = new PropertyDescriptor("jetCoefficientC0", SegmentGateVelocityFillingType.class); //$NON-NLS-1$
      ...
      properties[5] = new PropertyDescriptor("jetCoefficientC1", SegmentGateVelocityFillingType.class); //$NON-NLS-1$
      ...
      properties[6] = new PropertyDescriptor("jetCoefficientC2", SegmentGateVelocityFillingType.class); //$NON-NLS-1$
      ...
      properties[7] = new PropertyDescriptor("jetCoefficientC3", SegmentGateVelocityFillingType.class); //$NON-NLS-1$
