...
public class OneDimensionalModel implements Model {
	...
	public Results run() {
		...
		// Nur fÃ¼r DruckSegmente: A*mue Ã¼ber schuetzoeffnung
    ...
    double Amue = 0;
		...
		do {
			double s, A_strahl, A_schuetz, mue_schuetz, dh;
			...
			//System.out.println("DEBUG: s_s: " + s_s);
...
//			// Vorkopffuellung: Wirksame Fallhoehe am Knoten 0
			dh = Math.min(OW - 0.5 * (h1[0] + h1[nx - 1]), max_dh);
